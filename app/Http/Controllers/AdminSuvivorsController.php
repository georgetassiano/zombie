<?php namespace App\Http\Controllers;
	...
	class AdminSuvivorsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Longitude","name"=>"lng"];
			...
			$this->form[] = ['label'=>'Gender','name'=>'gender','type'=>'radio','validation'=>'required|min:1|max:255','width'=>'col-sm-10','dataenum'=>'M;F;Other'];
			$this->form[] = ['label'=>'Latitude','name'=>'lat','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Longitude','name'=>'lng','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
